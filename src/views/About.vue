  ...
  <div class="about">
    <div class="about-header">
      ...
      <a class="about-content">
        ...
        <router-link to="/login" class="content-text">
          <p>{{this.$store.state.username != "" ? this.$store.state.username :"注册/登录"}}</p>
          <div>
            <span class="mui-icon-extra mui-icon-extra-phone"></span>
            <span>{{this.$store.state.username != "" ? this.$store.state.username :"登录后享受更多特权"}}</span>
          </div>
        </router-link>
      ...
      <!-- 红包 -->
      <div class="money">
        <div class="hongbao money-item">
          <img
            class="item-msg"
            v-if="this.$store.getters.isLoginning"
            src="../img/about/hongbao.png"
          >
          <p class="item-text" v-if="!this.$store.getters.isLoginning">
            0
            <span>个</span>
          </p>
          <p>红包</p>
        </div>
        <div class="jinbi money-item">
          <img
            class="item-msg"
            v-if="this.$store.getters.isLoginning"
            src="../img/about/gold-coin.png"
          >
          <p class="item-text" v-if="!this.$store.getters.isLoginning">
            0
            <span>个</span>
      ...
      <!-- 我的地址 -->
      <ul class="mui-table-view myMap">
        <li class="mui-table-view-cell">
          <a class="mui-navigate-right">
            <img src="../img/about/map-marked.png">
            我的地址
          </a>
        </li>
      </ul>
      ...
      <ul class="mui-table-view myMap">
        <li class="mui-table-view-cell">
          <a class="mui-navigate-right">
            <img src="../img/about/bag.png">
            金币商城
          </a>
        </li>
        <li class="mui-table-view-cell">
          <a class="mui-navigate-right">
            <img src="../img/about/point-gift.png">
            分享拿20元现金
          </a>
        </li>
      </ul>
      ...
      <ul class="mui-table-view myMap">
        ...
        <li class="mui-table-view-cell">
          <a class="mui-navigate-right">
            <img src="../img/about/ios-apps.png">
            下载APP
          </a>
        </li>
        <li class="mui-table-view-cell">
          <a class="mui-navigate-right">
            <img src="../img/about/article-fill.png">
            规则中心
          </a>
        </li>
      </ul>
